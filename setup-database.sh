...
psql -d postgres -a -f /opt/elucidate/elucidate-db-scripts/group_roles/annotations_role.sql \
        ...
        && psql -d annotations -a -f /opt/elucidate/elucidate-db-scripts/sequences/annotation_collection_id_seq.sql \
        && psql -d annotations -a -f /opt/elucidate/elucidate-db-scripts/sequences/annotation_id_seq.sql \
